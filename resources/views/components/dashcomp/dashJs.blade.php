    ...
    <script src="../../dashboard/vendors4/datatables.net-bs4/js/dataTables.bootstrap4.min.js"></script>
    <script src="../../dashboard/vendors4/datatables.net-dt/js/dataTables.dataTables.min.js"></script>
    <script src="../../dashboard/vendors4/datatables.net-buttons/js/dataTables.buttons.min.js"></script>
    <script src="../../dashboard/vendors4/datatables.net-buttons-bs4/js/buttons.bootstrap4.min.js"></script>
    <script src="../../dashboard/vendors4/datatables.net-buttons/js/buttons.flash.min.js"></script>
    <script src="../../dashboard/vendors4/jszip/dist/jszip.min.js"></script>
    <script src="../../dashboard/vendors4/pdfmake/build/pdfmake.min.js"></script>
    <script src="../../dashboard/vendors4/pdfmake/build/vfs_fonts.js"></script>
    <script src="../../dashboard/vendors4/datatables.net-buttons/js/buttons.html5.min.js"></script>
    <script src="../../dashboard/vendors4/datatables.net-buttons/js/buttons.print.min.js"></script>
    <script src="../../dashboard/vendors4/datatables.net-responsive/js/dataTables.responsive.min.js"></script>
    <script src="../../dashboard/dist/js/dataTables-data.js"></script>
