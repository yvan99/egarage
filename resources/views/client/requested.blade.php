                            ...
                            <td>
                               ...
                               <button class="btn btn-sm btn-success feed-id">Successful</button>
                                    ...
                                    <button class="btn btn-sm btn-secondary feed-id" data-target="#exampleModalCenter"
                                        data-toggle="modal" data-id={{ $requested->appserv_id }}>Confirm
                                        service</button>
                                @endif
                            </td>
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h5 class="modal-title"> <img src="../../homepage/images/icons/confirm.png" alt="">
                                    Confirm service</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <form method="post" action="{{ route('confirm-service') }}">
                                @csrf
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col-12 pt-3">
                                            <input id="feed_id" name="cid" type="hidden" value="" />
                                            <h6>Are you sure you want to confirm this service ? . If yes how would you
