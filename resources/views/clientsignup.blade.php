    ...
    <div class="container mt-5 mb-5 d-flex justify-content-center">
        ...
        <div class="card px-1 py-4 rounded-lg">
            ...
            @endif
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                           <input class="form-control" type="text"
                                placeholder="Name" name="names" value="{{old('names')}}">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            <div class="input-group"> <input class="form-control" type="text" placeholder="Mobile" name="mobilee" value="{{old('mobilee')}}">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            <div class="input-group">
                                <input class="form-control" type="email" placeholder="Email ID" name="email" value="{{old('email')}}>
                            </div>
                        </div>
                    </div>
                ...
                <button class="btn btn-dark text-warning btn-block confirm-button shadow-lg mt-2">Create Account</button>
            </div>
        </div>
    </div>
